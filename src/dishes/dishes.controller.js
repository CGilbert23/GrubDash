...
const checkName = isValidDish("name");
const checkDescription = isValidDish("description");
const checkImageUrl = isValidDish("image_url");
...
module.exports = {
  create: [checkName, checkDescription, checkPrice, checkImageUrl, create],
