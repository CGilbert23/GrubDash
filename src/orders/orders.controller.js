...
const checkDeliveTo = checkData("deliverTo");
const checkCellNumber = checkData("mobileNumber");
...
module.exports = {
  create: [checkDeliveTo, checkCellNumber, checkDishes, quatityDishes, create],
